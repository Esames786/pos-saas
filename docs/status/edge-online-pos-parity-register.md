...
| Supplier finance (SUPPLIER-FINANCE-DIRECT-1, canonical since 70d24c1: direct supplier payment without a purchase bill · Supplier Ledger → Record Payment · supplier-aware General Journal / AP entry) | — | Cloud AP/GL (`postSupplierPayment`, Dr 2100 / Cr cash-bank); no offline ingestion/authority yet, no local AP/GL ever invented | — | — | **FINANCIAL_PARITY_PENDING** (SUPPLIER_FINANCE_OFFLINE_PARITY) | gap doc |
