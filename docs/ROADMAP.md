...
> Last updated: **2026-08-03** (PRINT-ROUTING-FOUNDATION-1 built and QA-certified locally; production not deployed) · branch `feat/14d-2-plan-upgrade-requests`
...
| F3 | (next) readiness/activation sprint — promote branch pending→active after bootstrap + local print readiness; + LOCAL-PRINT-LAN-1 / OFFLINE-SYNC-ENGINE-1 | **next** |
