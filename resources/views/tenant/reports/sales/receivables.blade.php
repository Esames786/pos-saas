@extends('layouts.app')
@section('title', 'Customer Receivables Aging')
@section('content')
<div class="page-header">
    <div class="page-title">
        <h4>Customer Receivables Aging</h4>
        <h6>Outstanding customer balances by age (as of {{ $asOf }})</h6>
    </div>
    <div class="page-btn">
    ...
    <div class="card-body p-0">
        <div class="table-responsive">
            <table class="table table-sm mb-0">
                <caption class="visually-hidden">Customer receivables aging</caption>
