...
<div class="page-header">
    <div class="page-title">
        ...
        <h6>Sales breakdown by table</h6>
    </div>
</div>
...
<div class="card border-0 shadow-sm">
    <div class="card-body p-0">
        <table class="table table-sm mb-0">
            <caption class="visually-hidden">Table sales performance</caption>
            <thead class="table-light">
                <tr>
                    ...
                    <th scope="col" class="text-end">Avg Bill</th>
                </tr>
            </thead>
            <tbody>
                @forelse($rows as $t)
                <tr>
                    ...
                    <td class="text-end fw-semibold">{{ number_format($t->net_sales, 2) }}</td>
                    <td class="text-end">{{ number_format($t->avg_bill, 2) }}</td>
                </tr>
                @empty
                <tr><td colspan="9" class="text-center text-muted py-4">No table sales.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
