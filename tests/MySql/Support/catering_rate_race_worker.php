...
try {
    switch ($mode) {
        ...
        case 'cancel':
            ...
            // Adopted from the independent certification (55ad8d5). These are the
            // everyday editing paths — not Rate Impact — and they were the ones that
            // could still land on a sent quotation.
        ...
        case 'material-reset':
            $snapshot = CateringEstimateLineCostBlock::findOrFail((int) $argv[2]);
            app(CateringLineCostBlockService::class)->resetMaterialQuantity($snapshot);
            echo 'OK:material-reset';
            break;
