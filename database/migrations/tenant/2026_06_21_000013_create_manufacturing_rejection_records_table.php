...
return new class extends Migration
{
    ...
    {
        Schema::connection('tenant')->create('manufacturing_rejection_records', function (Blueprint $table) {
            $table->id();
            $table->string('rejection_no', 50)->unique();
            ...
            $table->string('rejection_type', 40)->default('quality_fail');
    ...
    {
        Schema::connection('tenant')->dropIfExists('manufacturing_rejection_records');
    }
};
