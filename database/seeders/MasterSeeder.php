    ...
    private function seedCommercialModules(): void
    {
        $modules = [
            [
                ...
                'route_module_keys' => ['tenant.pos', 'tenant.held-sales', 'tenant.sales-orders', 'tenant.sales-returns', 'tenant.sales-ledger', 'tenant.customers', 'tenant.ajax.customers', 'tenant.payment-methods', 'tenant.delivery-channels', 'tenant.delivery-riders'],
                'sort_order' => 10,
                'is_core' => true,
            ],
            [
