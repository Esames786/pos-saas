    ...
    private function seedCommercialModules(): void
    {
        $modules = [
            ...
            [
                ...
                'route_module_keys' => ['tenant.inventory', 'tenant.stock-adjustments', 'tenant.stock-transfers', 'tenant.departments', 'tenant.department-stock', 'tenant.department-consumption-exceptions'],
                'sort_order' => 30,
                'is_core' => false,
            ],
            [
